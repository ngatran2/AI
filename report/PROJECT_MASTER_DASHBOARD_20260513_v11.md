...
| :--- | :--- | :--- | :--- |
| **Jira (ALM)** | 🟢 Connected | Browser/API | Auto-log Bug & Tracking (127 Bugs) |
...
| :--- | :--- | :--- | :---: | :---: | :---: | :---: | :---: |
| **UC-DM-10** | Quản lý danh mục hãng bay | ✅ Completed | ✅ v7 | ✅ v4 | ✅ HL/DET | ✅ Executed | 🐞 [v2](file:///d:/AI/Newtemplate/report/bug-report_LAMS_20260513_v2.md) |
| **UC-DM-11** | Quản lý loại thẻ | 🔄 In Progress | ✅ v4 | ✅ v2 | ⏳ Pending | ⏳ Pending | ⏳ Pending |
| **UC-DM-12** | Quản lý danh mục sân bay | ✅ Completed | ✅ v3 | ✅ v1 | ✅ HL/DET | ✅ Executed | 🐞 [v2](file:///d:/AI/Newtemplate/report/bug-report_LAMS_20260513_v2.md) |
| **UC-DN-01** | Login 2FA | ✅ Completed | ✅ v2 | ✅ v2 | ✅ HL/DET | ✅ Executed | 🐞 [v2](file:///d:/AI/Newtemplate/report/bug-report_LAMS_20260513_v2.md) |
...
| :--- | :--- | :--- | :--- | :--- |
| **Project Wide** | 88% (TRUSTED) | 127 Bugs (2 Open) | 🟢 Stable | Jira Status verified via JQL. |
...
- **2026-05-13:** Hiệu chỉnh báo cáo Jira Bug (v2). Xác nhận chỉ có 2 Bug To Do và 0 Bug In Progress.
- **2026-05-13:** Kết nối thành công Jira Agent. Trích xuất 127 Bug từ dự án LAMS.
