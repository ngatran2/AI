...
|--------------------|---------------|--------------------|---------------------------------------------|
| **Trường Mã thẻ** | Text field | Nhập text | Tự động viết hoa khi nhập chữ thường. Tối đa 30 ký tự. Chỉ nhận chữ, số, không có khoảng trắng. Required. |
...
|----------------|----------|---------------------|-----------|-------------------------------|
| Mã thẻ | Yes | Chữ hoa, số, không có khoảng trắng | Max 30 | "Mã thẻ đã tồn tại trong hãng bay này." |
